...
Source0  : https://download.samba.org/pub/samba/stable/samba-4.17.1.tar.gz
Source1  : samba.tmpfiles
Summary  : Generate parsers / DCE/RPC-clients from IDL
Group    : Development/Tools
License  : BSD-3-Clause BSD-4-Clause-UC BSL-1.0 CC-BY-4.0 EPL-1.0 GPL-3.0 HPND ISC MIT Public-Domain X11
...
Patch3: 0004-no-man-pages.patch
...
%prep
%setup -q -n samba-4.17.1
cd %{_builddir}/samba-4.17.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a samba-4.17.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666720038
