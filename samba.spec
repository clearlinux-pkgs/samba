...
Version  : 4.6.3
Release  : 21
URL      : https://github.com/samba-team/samba/archive/samba-4.6.3.tar.gz
Source0  : https://github.com/samba-team/samba/archive/samba-4.6.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1493210345
...
/usr/lib64/libsamba-passdb.so.0.26.0
...
/usr/lib64/samba/libldb.so.1.1.29
...
/usr/lib64/samba/libpyldb-util.so.1.1.29
...
/usr/lib64/samba/libtdb.so.1.3.12
/usr/lib64/samba/libtevent.so.0
/usr/lib64/samba/libtevent.so.0.9.31
