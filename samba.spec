...
Source0  : https://download.samba.org/pub/samba/stable/samba-4.17.4.tar.gz
...
%prep
%setup -q -n samba-4.17.4
cd %{_builddir}/samba-4.17.4
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a samba-4.17.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671477909
...
cp %{_builddir}/samba-%{version}/librpc/idl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/samba/41bb27089429d9d6febf18e4237cf04d81fcc737
...
/usr/lib64/libsamba-policy.cpython-311-x86-64-linux-gnu.so
...
/usr/lib64/libsamba-policy.cpython-311-x86-64-linux-gnu.so.0
/usr/lib64/libsamba-policy.cpython-311-x86-64-linux-gnu.so.0.0.1
...
/usr/lib64/samba/libsamba-net.cpython-311-x86-64-linux-gnu-samba4.so
/usr/lib64/samba/libsamba-python.cpython-311-x86-64-linux-gnu-samba4.so
