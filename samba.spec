...
Version  : 4.6.1
Release  : 18
URL      : https://github.com/samba-team/samba/archive/samba-4.6.1.tar.gz
Source0  : https://github.com/samba-team/samba/archive/samba-4.6.1.tar.gz
...
%prep
%setup -q -n samba-samba-4.6.1
%patch1 -p1
%patch2 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1490285903
