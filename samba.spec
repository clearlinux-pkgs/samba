...
Version  : 4.5.4
Release  : 14
URL      : https://github.com/samba-team/samba/archive/samba-4.5.4.tar.gz
Source0  : https://github.com/samba-team/samba/archive/samba-4.5.4.tar.gz
...
%prep
%setup -q -n samba-samba-4.5.4
%patch1 -p1
%patch2 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485016837
...
/usr/lib64/samba/libldb.so.1.1.27
...
/usr/lib64/samba/libpyldb-util.so.1.1.27
/usr/lib64/samba/libpytalloc-util.so.2
/usr/lib64/samba/libpytalloc-util.so.2.1.8
...
/usr/lib64/samba/libtalloc.so.2.1.8
/usr/lib64/samba/libtdb-wrap-samba4.so
/usr/lib64/samba/libtdb.so.1
/usr/lib64/samba/libtdb.so.1.3.10
/usr/lib64/samba/libtevent.so.0
/usr/lib64/samba/libtevent.so.0.9.29
