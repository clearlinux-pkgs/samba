...
Source0  : https://download.samba.org/pub/samba/stable/samba-4.17.3.tar.gz
...
%prep
%setup -q -n samba-4.17.3
cd %{_builddir}/samba-4.17.3
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a samba-4.17.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668703602
