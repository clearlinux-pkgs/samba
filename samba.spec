...
%prep
%setup -q -n samba-4.15.0
cd %{_builddir}/samba-4.15.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
cp %{_builddir}/samba-4.15.0/ctdb/COPYING %{buildroot}/usr/share/package-licenses/samba/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/samba-4.15.0/examples/pcap2nbench/COPYING %{buildroot}/usr/share/package-licenses/samba/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/samba-4.15.0/librpc/idl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/samba/41bb27089429d9d6febf18e4237cf04d81fcc737
cp %{_builddir}/samba-4.15.0/source3/librpc/idl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/samba/41bb27089429d9d6febf18e4237cf04d81fcc737
cp %{_builddir}/samba-4.15.0/source4/heimdal/HEIMDAL-LICENCE.txt %{buildroot}/usr/share/package-licenses/samba/2004537f8b8c3aee21a03133e1f4aaed6dc9a90c
cp %{_builddir}/samba-4.15.0/source4/librpc/idl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/samba/41bb27089429d9d6febf18e4237cf04d81fcc737
cp %{_builddir}/samba-4.15.0/source4/setup/adprep/WindowsServerDocs/LICENSE %{buildroot}/usr/share/package-licenses/samba/8ea3090863330c454ba0f536177bc1a8ee5de1b0
