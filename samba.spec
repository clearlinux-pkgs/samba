...
Version  : 4.14.4
Release  : 135
URL      : https://download.samba.org/pub/samba/stable/samba-4.14.4.tar.gz
Source0  : https://download.samba.org/pub/samba/stable/samba-4.14.4.tar.gz
...
%prep
%setup -q -n samba-4.14.4
cd %{_builddir}/samba-4.14.4
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619728280
...
cp %{_builddir}/samba-4.14.4/COPYING %{buildroot}/usr/share/package-licenses/samba/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/samba-4.14.4/ctdb/COPYING %{buildroot}/usr/share/package-licenses/samba/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/samba-4.14.4/examples/pcap2nbench/COPYING %{buildroot}/usr/share/package-licenses/samba/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/samba-4.14.4/librpc/idl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/samba/41bb27089429d9d6febf18e4237cf04d81fcc737
cp %{_builddir}/samba-4.14.4/source3/librpc/idl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/samba/41bb27089429d9d6febf18e4237cf04d81fcc737
cp %{_builddir}/samba-4.14.4/source4/heimdal/HEIMDAL-LICENCE.txt %{buildroot}/usr/share/package-licenses/samba/2004537f8b8c3aee21a03133e1f4aaed6dc9a90c
cp %{_builddir}/samba-4.14.4/source4/librpc/idl/IDL_LICENSE.txt %{buildroot}/usr/share/package-licenses/samba/41bb27089429d9d6febf18e4237cf04d81fcc737
cp %{_builddir}/samba-4.14.4/source4/setup/adprep/WindowsServerDocs/LICENSE %{buildroot}/usr/share/package-licenses/samba/8ea3090863330c454ba0f536177bc1a8ee5de1b0
cp %{_builddir}/samba-4.14.4/source4/setup/adprep/WindowsServerDocs/LICENSE-CODE %{buildroot}/usr/share/package-licenses/samba/c75814379854cf0de2911449fca8c9138520f140
cp %{_builddir}/samba-4.14.4/third_party/pep8/LICENSE %{buildroot}/usr/share/package-licenses/samba/37984ab2838de7795cd108336e00844e490457cb
cp %{_builddir}/samba-4.14.4/third_party/popt/COPYING %{buildroot}/usr/share/package-licenses/samba/61bb7a8ea669080cfc9e7dbf37079eae70b535fb
